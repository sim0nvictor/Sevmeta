...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full backdrop-blur-md bg-black/80 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <Link
            to="/#home"
            className="flex items-center transition-transform hover:scale-95"
            onClick={closeMenu}
          >
            <img
              src={Sev}
